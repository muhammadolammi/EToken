...
public interface ICustomerDeviceRepository
{
    ...
    Task<CustomerDevice?> GetActiveByCifAsync(Guid cif, CancellationToken ct = default);
    Task<IEnumerable<CustomerDevice>> GetAllByCifAsync(Guid cif, CancellationToken ct = default);
